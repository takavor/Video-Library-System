 ...
 */
public class TVShow extends WatchableModel implements Watchable, Bingeable<TVShow.Episode> {
	 ...
	 * on the file system.
	 */
	public class Episode extends WatchableModel implements Sequenceable<Episode>, Cloneable {
